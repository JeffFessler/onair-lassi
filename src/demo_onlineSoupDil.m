%%
% Compare SOUP-DIL and online SOUP-DIL for video denoising
%
% Brian Moore
% brimoor@umich.edu
%
...
nIters1  = 15;                      % # SOUP-DIL iters
nIters2i = 15;                      % # iters-init online SOUP-DIL
nIters2  = 5;                       % # iters/time online SOUP-DIL
flag     = 1;                       % Print stats?
...
opts1.flag   = flag;
[D1, B1, stats1] = soupDil(Z,mu,opts1);
cost1 = stats1.cost(:);
...
opts2.flag   = flag;
[Dt, Bt, params, stats2] = onlineSoupDil(Z1,mu,gamma,opts2);
cost2(:,1) = stats2.cost(:);
...
for i = 2:ni
    ...
    [Dt, Bt, params, stats2] = onlineSoupDil(Zt,mu,gamma,opts2);
